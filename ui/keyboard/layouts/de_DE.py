...
layout_de_de = KeyboardLayout(
    ...
    keys={
        **layout_en_us.keys,
        ...
        ScanCode.Q: LayoutKey("q", {Modifier.SHIFT: "Q", Modifier.ALTGR: "@"}, is_letter=True),
        ScanCode.E: LayoutKey("e", {Modifier.SHIFT: "E", Modifier.ALTGR: "€"}, is_letter=True),
        ScanCode.Y: LayoutKey("z", {Modifier.SHIFT: "Z"}, is_letter=True),
        ScanCode.LEFTBRACE: LayoutKey("ü", {Modifier.SHIFT: "Ü"}, is_letter=True),
        ScanCode.RIGHTBRACE: LayoutKey("+", {Modifier.SHIFT: "*", Modifier.ALTGR: "~"}),
        ScanCode.SEMICOLON: LayoutKey("ö", {Modifier.SHIFT: "Ö"}, is_letter=True),
        ScanCode.APOSTROPHE: LayoutKey("ä", {Modifier.SHIFT: "Ä"}, is_letter=True),
        ScanCode.HASHTILDE_ISO: LayoutKey("#", {Modifier.SHIFT: "'"}),
        ScanCode.BACKSLASH_ISO: LayoutKey("<", {Modifier.SHIFT: ">", Modifier.ALTGR: "|"}),
        ScanCode.Z: LayoutKey("y", {Modifier.SHIFT: "Y"}, is_letter=True),
        ScanCode.M: LayoutKey("m", {Modifier.SHIFT: "M", Modifier.ALTGR: "µ"}, is_letter=True),
