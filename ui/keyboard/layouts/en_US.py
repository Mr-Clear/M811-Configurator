...
layout_en_us = KeyboardLayout(
    ...
    keys={
        **general_keys,
        ...
        ScanCode.Q: LayoutKey("q", {Modifier.SHIFT: "Q"}, is_letter=True),
        ScanCode.W: LayoutKey("w", {Modifier.SHIFT: "W"}, is_letter=True),
        ScanCode.E: LayoutKey("e", {Modifier.SHIFT: "E"}, is_letter=True),
        ScanCode.R: LayoutKey("r", {Modifier.SHIFT: "R"}, is_letter=True),
        ScanCode.T: LayoutKey("t", {Modifier.SHIFT: "T"}, is_letter=True),
        ScanCode.Y: LayoutKey("y", {Modifier.SHIFT: "Y"}, is_letter=True),
        ScanCode.U: LayoutKey("u", {Modifier.SHIFT: "U"}, is_letter=True),
        ScanCode.I: LayoutKey("i", {Modifier.SHIFT: "I"}, is_letter=True),
        ScanCode.O: LayoutKey("o", {Modifier.SHIFT: "O"}, is_letter=True),
        ScanCode.P: LayoutKey("p", {Modifier.SHIFT: "P"}, is_letter=True),
        ...
        ScanCode.A: LayoutKey("a", {Modifier.SHIFT: "A"}, is_letter=True),
        ScanCode.S: LayoutKey("s", {Modifier.SHIFT: "S"}, is_letter=True),
        ScanCode.D: LayoutKey("d", {Modifier.SHIFT: "D"}, is_letter=True),
        ScanCode.F: LayoutKey("f", {Modifier.SHIFT: "F"}, is_letter=True),
        ScanCode.G: LayoutKey("g", {Modifier.SHIFT: "G"}, is_letter=True),
        ScanCode.H: LayoutKey("h", {Modifier.SHIFT: "H"}, is_letter=True),
        ScanCode.J: LayoutKey("j", {Modifier.SHIFT: "J"}, is_letter=True),
        ScanCode.K: LayoutKey("k", {Modifier.SHIFT: "K"}, is_letter=True),
        ScanCode.L: LayoutKey("l", {Modifier.SHIFT: "L"}, is_letter=True),
        ...
        ScanCode.Z: LayoutKey("z", {Modifier.SHIFT: "Z"}, is_letter=True),
        ScanCode.X: LayoutKey("x", {Modifier.SHIFT: "X"}, is_letter=True),
        ScanCode.C: LayoutKey("c", {Modifier.SHIFT: "C"}, is_letter=True),
        ScanCode.V: LayoutKey("v", {Modifier.SHIFT: "V"}, is_letter=True),
        ScanCode.B: LayoutKey("b", {Modifier.SHIFT: "B"}, is_letter=True),
        ScanCode.N: LayoutKey("n", {Modifier.SHIFT: "N"}, is_letter=True),
        ScanCode.M: LayoutKey("m", {Modifier.SHIFT: "M"}, is_letter=True),
